...
$(document).ready(function(){
    $('input[type="checkbox"]').click(function(){
        if($(this).attr("value")=="Bulldog"){
            $(".Bulldog").toggle();
			$(".main").hide();
        }
        if($(this).attr("value")=="Beagle"){
            $(".Beagle").toggle();
			$(".main").hide();
        }
      ...
      <div class="container ">
        ...
        <div id="navbar" class="navbar-collapse nd ">
          ...
          <ul class="nav navbar-nav navbar-right ">
            ...
            <li><a href="STORELOCATOR.php" style="color:black"><font class="game" ><h4>Store Locator</h4></font></a></li>
			<li><a href="BLOGPAGE.php" style="color:black"><font class="game" style="color:black"><h4>Blog</h4></font></a></li>
            <li><a href="" style="color:black"><font class="game" style="color:black"><h4>Locations</h4></font></a></li>
			<li class="dropdown">
			...
			<br>
							...
							<div class="panel panel-default">
								...
								<div id="sportswear" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<?php
												$query="SELECT * FROM dogs WHERE lookfor='{$_SESSION['lookfor']}' group by breed ORDER BY id";
				...
				while($row=mysqli_fetch_assoc($select_all_events)){
					...
					$b=$row['breed'];	
											...
											?>
											<li><a href="#"><?php echo $b;?><input type="checkbox" name="<?php echo $b ?>" value="<?php echo $b ?>" class="pull-right" ></li>
		...
		<div class="container">
			...
			echo "hi";
				...
				<div class="Bulldog box">
					 <?php
												$q="SELECT * FROM dogs WHERE breed='Bulldog' group by owner ORDER BY id";
				...
				$im=$row['image'];
					  ...
					  <div class="col-sm-4 col-md-4 ">
		                    <div class="blog-thumb">
		                        <a href="INDIVIDUALSTORE.php?p_id=<?php  echo $i;  ?>">
		                ...
		                <div class="col-sm-8 col-md-8">
		                    <h4 class="game">
		                        <a href="INDIVIDUALSTORE.php?cat_id=DOGS&p_id=<?php  echo $i;  ?>&p_name=<?php  echo $na;  ?>"  class="game" ><b><?php echo $na ?></b></a>
		                    </h4>
				...
				<?php } ?>
					 	...
					 	<div class="Beagle box">
					 <?php
												$q="SELECT * FROM dogs WHERE breed='Beagle' group by owner ORDER BY id";
				$select_all=mysqli_query($connection,$q);
				...
				$img=$row['image'];
					  ...
					  <div class="col-sm-4 col-md-4 ">
		                    <div class="blog-thumb">
		                        <a href="INDIVIDUALSTORE.php?p_id=<?php  echo $it;  ?>">
		                ...
		                <div class="col-sm-8 col-md-8">
		                    <h4 class="game">
		                        <a href="INDIVIDUALSTORE.php?cat_id=DOGS&p_id=<?php  echo $it;  ?>&p_name=<?php  echo $nan;  ?>"  class="game" ><b><?php echo $nan ?></b></a>
		                    </h4>
		 ...
		 for($i=1;$i<=$count;$i++){
			 ...
			 echo "<li class='active'><a href='tryyyy.php?page={$i}'>$i</a></li>";
