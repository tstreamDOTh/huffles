      ...
      <div class="container ">
        ...
        <div id="navbar" class="navbar-collapse nd ">
          ...
          <ul class="nav navbar-nav navbar-right ">
            ...
            <li><a href="#navModal" role="button" data-toggle="modal" style="color:black"><font class="game"><b>Store Locator</b></font></a></li>
			<li><a href="blogs.php" style="color:black"><font class="game"><b>Blog</b></font></a></li>
            <li><a href="#locat" style="color:black"><font class="game"><b>Locations</b></font><span class="sr-only">(current)</span></a></li>
			<li class="dropdown">
				...
				?>
		            ...
		            <div class="row blogu">
		                ...
		                <div class="col-sm-8 col-md-8">
		                    ...
		                    <p class="game"><?php echo   strip_tags(html_entity_decode($content)); ?></p>
