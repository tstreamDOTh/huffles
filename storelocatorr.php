      ...
      <div class="container">
         ...
         <div id="navbar" class="navbar-collapse collapse ff">
          ...
          <ul class="nav navbar-nav navbar-right ">
            ...
            <li><a href="storelocatorr.php" style="color:black"><b><h4 class="game">Store Locator</h4></b></a></li>
		...
		<div class="container">
		 ...
		 for($i=1;$i<=$count;$i++){
		  ...
		  ?>
				...
				?>
                                <li><a href="indivstore.php?p_id=<?php  echo $name;  ?>"><font class="game"> <?php echo $name ?></font></a>
                                </li>
